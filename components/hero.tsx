        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="z-10">
            ...
            <p className="text-lg text-foreground/70 mb-8 leading-relaxed max-w-lg">
              At Luxury's Dream, our skin care premium can make beautiful to bring out the best in your skin and leave
          ...
          <div className="relative">
            ...
            <div className="relative z-10 rounded-[2.5rem] overflow-hidden">
              <img src="/luxury-beauty-woman-skincare.jpg" alt="Beauty model" className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </div>
