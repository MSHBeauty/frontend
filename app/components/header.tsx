      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button className="text-primary hover:text-primary/80 transition">Log In</button>
        ...
        {isOpen && (
          <div className="md:hidden mt-4 space-y-4 pb-4">
            ...
            <div className="pt-4 space-y-2">
              <button className="w-full text-primary hover:text-primary/80">Log In</button>
              <button className="w-full bg-primary text-primary-foreground px-6 py-2 rounded-full font-semibold hover:bg-primary/90">
                Sign Up
              </button>
            </div>
          </div>
